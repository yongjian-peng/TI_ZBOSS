...
build-1672411441: ../on_off_light.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/sysconfig_1.23.1/sysconfig_cli.bat" --script "C:/Users/xwb/workspace_ccstheia/onoff_light_LP_EM_CC2340R53_freertos_ticlang/on_off_light.syscfg" -o "syscfg" -s "C:/ti/simplelink_lowpower_f3_sdk_9_10_00_83/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

syscfg/ti_devices_config.c: build-1672411441 ../on_off_light.syscfg
syscfg/ti_radio_config.c: build-1672411441
syscfg/ti_radio_config.h: build-1672411441
syscfg/ti_drivers_config.c: build-1672411441
syscfg/ti_drivers_config.h: build-1672411441
syscfg/ti_utils_build_linker.cmd.genlibs: build-1672411441
syscfg/ti_utils_build_linker.cmd.genmap: build-1672411441
syscfg/ti_utils_build_compiler.opt: build-1672411441
syscfg/syscfg_c.rov.xs: build-1672411441
syscfg/ti_zigbee_config.h: build-1672411441
syscfg/ti_zigbee_config.c: build-1672411441
syscfg/FreeRTOSConfig.h: build-1672411441
syscfg/ti_freertos_config.c: build-1672411441
syscfg/ti_freertos_portable_config.c: build-1672411441
syscfg: build-1672411441
